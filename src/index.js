...
iss.loadPartOfModel(scene,'http://localhost:8000/station/destiny_USA.fbx',0.1,new ThirdDimensionVector(0,100,0),'destiny_USA');
...
iss.loadPartOfModel(scene,'http://localhost:8000/station/harmony_mod.fbx',0.1,new ThirdDimensionVector(0,100,0),'harmony_mod');
...
iss.loadPartOfModel(scene,'http://localhost:8000/station/isscombine_idk.fbx',0.1,new ThirdDimensionVector(0,100,0),'isscomine_idk');
iss.loadPartOfModel(scene,'http://localhost:8000/station/jem_elm_ps.fbx',0.1,new ThirdDimensionVector(0,100,0),'jem_elm_ps');
iss.loadPartOfModel(scene,'http://localhost:8000/station/JEM_RMS&E.fbx',0.1,new ThirdDimensionVector(0,100,0),'JEME');
iss.loadPartOfModel(scene,'http://localhost:8000/station/Kibo_JEM.fbx',0.1,new ThirdDimensionVector(0,100,0),'Kibo_JEM');
iss.loadPartOfModel(scene,'http://localhost:8000/station/Nauka_Lab.fbx',0.1,new ThirdDimensionVector(0,100,0),'Nauka_LAB');
iss.loadPartOfModel(scene,'http://localhost:8000/station/P1truss_segment.fbx',0.1,new ThirdDimensionVector(0,100,0),'P1truss_segment');
iss.loadPartOfModel(scene,'http://localhost:8000/station/PMA-2.fbx',0.1,new ThirdDimensionVector(0,100,0),'PMA-2');
iss.loadPartOfModel(scene,'http://localhost:8000/station/S1truss_segment.fbx',0.1,new ThirdDimensionVector(0,100,0),'S1truss_segment');
